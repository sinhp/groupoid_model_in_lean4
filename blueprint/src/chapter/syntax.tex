...
\AxiomC{$\Gamma, x :A \vdash b(x) : B(x)$}
\BinaryInfC{$\Gamma \vdash \langle a,b(a)\rangle : \sum_{x :A} B(x) $}
\end{bprooftree}
\]
\[
\begin{bprooftree}
...
\begin{bprooftree}
\AxiomC{$\Gamma, x: A \vdash b(x) : B(x)$}
\UnaryInfC{$\Gamma, a:A\vdash \text{fst}(\langle a,b(a)\rangle) \equiv a : A $}
\end{bprooftree}
\begin{bprooftree}
\AxiomC{$\Gamma, x: A \vdash b(x) : B(x)$}
\UnaryInfC{$\Gamma, a:A\vdash \text{snd}(\langle a,b(a)\rangle) \equiv b(a) : B(a) $}
\end{bprooftree}
\]
