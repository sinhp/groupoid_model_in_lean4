...
-/
protected structure Id' (i : IdIntro M) (N : NaturalModel Ctx) where
...
variable {M} {N : NaturalModel Ctx} {ii : M.IdIntro} (i : M.Id' ii N) {Γ : Ctx} (a : y(Γ) ⟶ M.Tm)
...
-/
structure Id {ii : IdIntro M} (ie : IdElimBase ii) (N : NaturalModel Ctx) where
...
variable {N : NaturalModel Ctx} {ii : IdIntro M} {ie : IdElimBase ii} (i : Id ie N)
...
variable {ii : IdIntro M} {ie : IdElimBase ii} {N : NaturalModel Ctx} (i : M.Id' ii N)
